...
const char* SALAMANDER_TEXT_VERSION = "Tandem Commander " VERSINFO_VERSION;
...
void CMainWindow::SetWindowTitle(const char* text)
{
    ...
    if (text == NULL)
    {
        ...
        char expire[100];
        if (SalGetDateFormatU8(LOCALE_USER_DEFAULT, DATE_LONGDATE, &BETA_EXPIRATION_DATE, NULL, expire, 100) == 0)
