...
static INT_PTR CALLBACK CfgDlgProc(HWND hDlg, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    {
    case WM_INITDIALOG:
        SetDlgItemTextA(hDlg, IDC_CFG_FONTNAME, g_fontFamily);
    ...
    case WM_COMMAND:
        ...
        {
            char font[64] = {0};
            GetDlgItemTextA(hDlg, IDC_CFG_FONTNAME, font, sizeof(font));
            if (font[0] != 0)
                lstrcpynA(g_fontFamily, font, sizeof(g_fontFamily));
